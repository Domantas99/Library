...
namespace BookLibrary.Services.Contracts
{
    public interface IBooksService
    {
        ...
        Task<ResponseResult<ICollection<BookListDTO>>> GetBooks(List<string> categories, List<string> offices, string status, List<string> authors, int userOffice, string sortField, int sortDirection);

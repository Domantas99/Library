...
export const RATE_BOOK = 'library/RATE_BOOK';
export const RATE_BOOK_END = 'library/RATE_BOOK_END';
...
export const SET_BOOK_ARCHIVE_STATUS_END =
  'library/SET_BOOK_ARCHIVE_STATUS_END';
